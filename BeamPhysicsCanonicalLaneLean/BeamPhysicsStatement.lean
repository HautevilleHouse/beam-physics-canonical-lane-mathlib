import BeamPhysicsCanonicalLaneLean.FinalTheorem
import BeamPhysicsCanonicalLaneLean.Core

namespace HautevilleHouse
namespace BeamPhysicsCanonicalLaneLean

def sourceRepository : String := "beam-physics-canonical-lane"
def sourceDescription : String := "Beam Physics Canonical Lane"
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedBeamClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_beam_endgame A
